class Monkey
{
    ...
    func takeTurn(monkeyList: Array<Monkey>)
    {
        for oldWorry in items
        {
            let newWorry = operation(oldWorry) / 3
...
func readMonkeyList() throws -> Array<Monkey>
{
    ...
    while let _ = readLine()
    {
        ...
        monkeyList.append(Monkey(initialItems: items,
                                 operation: operation,
                                 testDivisibleBy: try getInt(readLine(), 3),
...
func doRounds(_ monkeyList: Array<Monkey>)
{
    for round in 1...20
    {
        print("Round \(round)")
        ...
        {
            monkey.takeTurn(monkeyList: monkeyList)
        }
...
func main()
{
    do
    {
        let monkeyList = try readMonkeyList()
