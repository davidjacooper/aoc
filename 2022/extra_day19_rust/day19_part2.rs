...
fn main()
{
    ...
    match std::fs::read_to_string(&file)
    {
        ...
        Ok(content) =>
        {
            ...
            not_enough_minerals_part2(&content);
...
fn not_enough_minerals_part2(content: &str)
{
    let mut product = 1;
    ...
    for line in content.lines().filter(|l| !l.is_empty())
    {
        ...
        for _time in 1..=32
        {
            ...
            new_states.truncate(648);
            states = new_states;
        }

        product *= states[0].geodes;
        println!("blueprint {}: geodes = {}", blueprint, states[0].geodes);
    }
